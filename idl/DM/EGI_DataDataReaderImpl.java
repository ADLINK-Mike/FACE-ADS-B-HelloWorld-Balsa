...
public class EGI_DataDataReaderImpl extends org.opensplice.dds.dcps.FooDataReaderImpl implements EGI_DataDataReader
{
    private static final long serialVersionUID = 1L;

    private long copyCache;
    private EGI_DataTypeSupport typeSupport;

    public EGI_DataDataReaderImpl(DM.EGI_DataTypeSupport ts)
    {
        typeSupport = ts;
    ...
    synchronized public int read(
            DM.EGI_DataSeqHolder received_data,
    ...
    synchronized public int read_next_sample(
            DM.EGI_DataHolder received_data,
    ...
    */
    ...
    {
        return new EGI_DataDataReaderViewImpl(typeSupport);
    }
}
