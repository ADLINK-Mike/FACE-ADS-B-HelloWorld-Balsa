...
public class Aircraft_ConfigDataWriterImpl extends org.opensplice.dds.dcps.DataWriterImpl implements Aircraft_ConfigDataWriter
{
    ...
    public Aircraft_ConfigDataWriterImpl(DM.Aircraft_ConfigTypeSupport ts)
    {
        typeSupport = ts;
