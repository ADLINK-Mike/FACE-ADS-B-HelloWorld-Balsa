...
public class ATC_DataDataWriterImpl extends org.opensplice.dds.dcps.DataWriterImpl implements ATC_DataDataWriter
{
    ...
    public ATC_DataDataWriterImpl(DM.ATC_DataTypeSupport ts)
    {
        typeSupport = ts;
