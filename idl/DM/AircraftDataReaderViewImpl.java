...
public class AircraftDataReaderViewImpl extends org.opensplice.dds.dcps.FooDataReaderViewImpl implements AircraftDataReaderView
{
    ...
    public AircraftDataReaderViewImpl(DM.AircraftTypeSupport ts)
    {
        typeSupport = ts;
