...
public class ATC_FunctionDataReaderImpl extends org.opensplice.dds.dcps.FooDataReaderImpl implements ATC_FunctionDataReader
{
    private static final long serialVersionUID = 1L;

    private long copyCache;
    private ATC_FunctionTypeSupport typeSupport;

    public ATC_FunctionDataReaderImpl(DM.ATC_FunctionTypeSupport ts)
    {
        typeSupport = ts;
    ...
    synchronized public int read(
            DM.ATC_FunctionSeqHolder received_data,
    ...
    synchronized public int read_next_sample(
            DM.ATC_FunctionHolder received_data,
    ...
    */
    ...
    {
        return new ATC_FunctionDataReaderViewImpl(typeSupport);
    }
}
