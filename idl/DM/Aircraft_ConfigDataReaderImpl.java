...
public class Aircraft_ConfigDataReaderImpl extends org.opensplice.dds.dcps.FooDataReaderImpl implements Aircraft_ConfigDataReader
{
    private static final long serialVersionUID = 1L;

    private long copyCache;
    private Aircraft_ConfigTypeSupport typeSupport;

    public Aircraft_ConfigDataReaderImpl(DM.Aircraft_ConfigTypeSupport ts)
    {
        typeSupport = ts;
    ...
    synchronized public int read(
            DM.Aircraft_ConfigSeqHolder received_data,
    ...
    synchronized public int read_next_sample(
            DM.Aircraft_ConfigHolder received_data,
    ...
    */
    ...
    {
        return new Aircraft_ConfigDataReaderViewImpl(typeSupport);
    }
}
