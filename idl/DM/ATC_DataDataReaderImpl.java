...
public class ATC_DataDataReaderImpl extends org.opensplice.dds.dcps.FooDataReaderImpl implements ATC_DataDataReader
{
    private static final long serialVersionUID = 1L;

    private long copyCache;
    private ATC_DataTypeSupport typeSupport;

    public ATC_DataDataReaderImpl(DM.ATC_DataTypeSupport ts)
    {
        typeSupport = ts;
    ...
    synchronized public int read(
            DM.ATC_DataSeqHolder received_data,
    ...
    synchronized public int read_next_sample(
            DM.ATC_DataHolder received_data,
    ...
    */
    ...
    {
        return new ATC_DataDataReaderViewImpl(typeSupport);
    }
}
