...
public class ATC_FunctionDataWriterImpl extends org.opensplice.dds.dcps.DataWriterImpl implements ATC_FunctionDataWriter
{
    ...
    public ATC_FunctionDataWriterImpl(DM.ATC_FunctionTypeSupport ts)
    {
        typeSupport = ts;
