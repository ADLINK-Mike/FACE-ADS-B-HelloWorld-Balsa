...
public class AircraftDataReaderImpl extends org.opensplice.dds.dcps.FooDataReaderImpl implements AircraftDataReader
{
    private static final long serialVersionUID = 1L;

    private long copyCache;
    private AircraftTypeSupport typeSupport;

    public AircraftDataReaderImpl(DM.AircraftTypeSupport ts)
    {
        typeSupport = ts;
    ...
    synchronized public int read(
            DM.AircraftSeqHolder received_data,
    ...
    synchronized public int read_next_sample(
            DM.AircraftHolder received_data,
    ...
    */
    ...
    {
        return new AircraftDataReaderViewImpl(typeSupport);
    }
}
