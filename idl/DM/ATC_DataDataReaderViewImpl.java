...
public class ATC_DataDataReaderViewImpl extends org.opensplice.dds.dcps.FooDataReaderViewImpl implements ATC_DataDataReaderView
{
    ...
    public ATC_DataDataReaderViewImpl(DM.ATC_DataTypeSupport ts)
    {
        typeSupport = ts;
