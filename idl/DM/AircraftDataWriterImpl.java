...
public class AircraftDataWriterImpl extends org.opensplice.dds.dcps.DataWriterImpl implements AircraftDataWriter
{
    ...
    public AircraftDataWriterImpl(DM.AircraftTypeSupport ts)
    {
        typeSupport = ts;
