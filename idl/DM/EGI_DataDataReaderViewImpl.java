...
public class EGI_DataDataReaderViewImpl extends org.opensplice.dds.dcps.FooDataReaderViewImpl implements EGI_DataDataReaderView
{
    ...
    public EGI_DataDataReaderViewImpl(DM.EGI_DataTypeSupport ts)
    {
        typeSupport = ts;
