...
public class EGI_DataDataWriterImpl extends org.opensplice.dds.dcps.DataWriterImpl implements EGI_DataDataWriter
{
    ...
    public EGI_DataDataWriterImpl(DM.EGI_DataTypeSupport ts)
    {
        typeSupport = ts;
